"""
Django settings for django_csrf project.
...
ROOT_URLCONF = 'django_csrf.urls'

TEMPLATE_FRONTEND_BUILD_DIR = os.path.join(BASE_DIR, 'build')

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            TEMPLATE_FRONTEND_BUILD_DIR,
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'django_csrf.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'statfiles'),
]
